...
map.getView().fit([12269653.144359, -798497.144880, 12359219.849695, -746647.951771], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NDVI KABUPATEN DEMAK</h2>';
        return titleElement;
    })(),
